        ...
        <div class="col-lg-9 col-md-7">
            <div class="product__discount">
                ...
                <div class="row">
                   ...
                   <c:forEach items="${homecares}" var="homecare">
                   <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="product__item">
                        <form id="myform" action="<%= request.getContextPath()%>/Products" method="post">
                            <input type="hidden" name = "pname" value="${homecare.productname}">
                            <input type="hidden" name = "price" value="${homecare.price}">
                            <input type="hidden" name = "category" value="${homecare.category}">
                            <input type="hidden" name = "image" value="${homecare.image}">
                            <input type="hidden" name = "disc" value="${homecare.discount}">
                            <input type="hidden" name = "noofitems" value="${homecare.number_of_items}">
                            <input type="hidden" name = "weight" value="${homecare.weight}">
                            <div class="product__item__pic set-bg" data-setbg="img/${homecare.image}">
                                <ul class="product__item__pic__hover">
                                    <c:choose>
                                        <c:when test= "${homecare.number_of_items!= 0}" >
                                            <ul class="product__item__pic__hover">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">${homecare.productname}</a></h6>
                                    <h5>$${homecare.price}</h5>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
