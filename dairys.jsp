        ...
        <div class="col-lg-9 col-md-7">
            <div class="product__discount">
                ...
                <div class="row">
                  ...
                  <c:forEach items="${dairys}" var="dairy">
                  <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="product__item">
                        <form id="myform" action="<%= request.getContextPath()%>/Products" method="post">
                            <input type="hidden" name = "pname" value="${dairy.productname}">
                            <input type="hidden" name = "price" value="${dairy.price}">
                            <input type="hidden" name = "category" value="${dairy.category}">
                            <input type="hidden" name = "image" value="${dairy.image}">
                            <input type="hidden" name = "disc" value="${dairy.discount}">
                            <input type="hidden" name = "noofitems" value="${dairy.number_of_items}">
                            <input type="hidden" name = "weight" value="${dairy.weight}">
                            <div class="product__item__pic set-bg" data-setbg="img/${dairy.image}">
                                <c:choose>
                                        <c:when test= "${dairy.number_of_items!= 0}" >
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">${dairy.productname}</a></h6>
                                    <h5>$${dairy.price}</h5>
                                </div>
                            </div>
                        </div>
