                   ...
                   <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="product__item">
                        <form id="myform" action="<%= request.getContextPath()%>/Products" method="post">
                            <input type="hidden" name = "pname" value="${beverage.productname}">
                            <input type="hidden" name = "price" value="${beverage.price}">
                            <input type="hidden" name = "category" value="${beverage.category}">
                            <input type="hidden" name = "image" value="${beverage.image}">
                            <input type="hidden" name = "disc" value="${beverage.discount}">
                            <input type="hidden" name = "noofitems" value="${beverage.number_of_items}">
                            <input type="hidden" name = "weight" value="${beverage.weight}">
                            <div class="product__item__pic set-bg" data-setbg="img/${beverage.image}">
                                <ul class="product__item__pic__hover">
                                    <li><button type="submit" class="fa fa-shopping-cart"></button><li>
                                        <!-- <li><a onclick="document.forms['myform'].submit();"><i class="fa fa-shopping-bag"></i></a> -->
                                        </ul>
                                    </div>
                                </form>  
                                <div class="product__item__text">
                                    <h6><a href="#">${beverage.productname}</a></h6>
