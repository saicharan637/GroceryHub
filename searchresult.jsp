            ...
            <div class="product__discount">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <input type="hidden" name = "disc" value="${discount}">
                        <input type="hidden" name = "noofitems" value="${number_of_items}">
                        <input type="hidden" name = "weight" value="${weight}">
                        <div class="product__item__pic set-bg" data-setbg="img/${image}">
                            <c:choose>
