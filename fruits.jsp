            ...
            <div class="product__discount">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item">
                            <form id="myform" action="<%= request.getContextPath()%>/Products" method="post">
                                <input type="hidden" name = "pname" value="${fruit.productname}">
                                <input type="hidden" name = "price" value="${fruit.price}">
                                <input type="hidden" name = "category" value="${fruit.category}">
                                <input type="hidden" name = "image" value="${fruit.image}">
                                <input type="hidden" name = "disc" value="${fruit.discount}">
                                <input type="hidden" name = "noofitems" value="${fruit.number_of_items}">
                                <input type="hidden" name = "weight" value="${fruit.weight}">
                                <div class="product__item__pic set-bg" data-setbg="img/${fruit.image}">
                                    <c:choose>
                                    <c:when test= "${fruit.number_of_items != 0}" >
                    ...
                    <div class="product__item__text">
                        <h6><a href="#">${fruit.productname}</a></h6>
                        <h5>$${fruit.price}</h5>
                    </div>
                </div>
            </div>
