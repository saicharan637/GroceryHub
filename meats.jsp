                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item">
                            <form id="myform" action="<%= request.getContextPath()%>/Products" method="post">
                                <input type="hidden" name = "pname" value="${meat.productname}">
                                <input type="hidden" name = "price" value="${meat.price}">
                                <input type="hidden" name = "category" value="${meat.category}">
                                <input type="hidden" name = "image" value="${meat.image}">
                                <input type="hidden" name = "disc" value="${meat.discount}">
                                <input type="hidden" name = "noofitems" value="${meat.number_of_items}">
                                <input type="hidden" name = "weight" value="${meat.weight}">
                                <div class="product__item__pic set-bg" data-setbg="img/${meat.image}">
                                    <c:choose>
                                    <c:when test= "${meat.number_of_items!= 0}" >
                                ...
                                <c:otherwise>
                                    ...
                                    <div class="product__item__text">
                                        <h6><a href="#">${meat.productname}</a></h6>
                                        <h5>$${meat.price}</h5>
                                    </div>
                                </div>
                            </div>
