        ...
        <div class="col-lg-9 col-md-7">
            <div class="product__discount">
                ...
                <div class="row">
                   ...
                   <c:forEach items="${personalcares}" var="personalcare">
                   <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="product__item">
                        <form id="myform" action="<%= request.getContextPath()%>/Products" method="post">
                            <input type="hidden" name = "pname" value="${personalcare.productname}">
                            <input type="hidden" name = "price" value="${personalcare.price}">
                            <input type="hidden" name = "category" value="${personalcare.category}">
                            <input type="hidden" name = "image" value="${personalcare.image}">
                            <input type="hidden" name = "disc" value="${personalcare.discount}">
                            <input type="hidden" name = "noofitems" value="${personalcare.number_of_items}">
                            <input type="hidden" name = "weight" value="${personalcare.weight}">
                            <div class="product__item__pic set-bg" data-setbg="img/${personalcare.image}">
                                <c:choose>
                                    <c:when test= "${personalcare.number_of_items!= 0}" >
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">${personalcare.productname}</a></h6>
                                    <h5>$${personalcare.price}</h5>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
