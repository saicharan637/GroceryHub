    ...
    <section class="product spad">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="product__discount">
                ...
                <div class="row">
                    <c:forEach items="${canneds}" var="canned">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item">
                            <form id="myform" action="<%= request.getContextPath()%>/Products" method="post">
                                <input type="hidden" name = "pname" value="${canned.productname}">
                                <input type="hidden" name = "price" value="${canned.price}">
                                <input type="hidden" name = "category" value="${canned.category}">
                                <input type="hidden" name = "image" value="${canned.image}">
                                <input type="hidden" name = "disc" value="${canned.discount}">
                                <input type="hidden" name = "noofitems" value="${canned.number_of_items}">
                                <input type="hidden" name = "weight" value="${canned.weight}">
                                <div class="product__item__pic set-bg" data-setbg="img/${canned.image}">
                                    <c:choose>
                                        <c:when test= "${canned.number_of_items!= 0}" >
                                    ...
                                    <div class="product__item__text">
                                        <h6><a href="#">${canned.productname}</a></h6>
                                        <h5>$${canned.price}</h5>
                                    </div>
                                </div>
                            </div>
