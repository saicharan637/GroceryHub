...
public class Frozens extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            Statement statement = conn.createStatement();
             if(sid==0){
                ...
                String selectStoreQuery = "Select * from product_details where s1='YES' and Category='frozen';";
                ...
                String selectStoreQuery = "Select * from product_details where s2='YES' and Category='frozen';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s3='YES' and Category='frozen';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s4='YES' and Category='frozen';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s5='YES' and Category='frozen';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
        ...
        int count=frozens.size();
        for(Product p : frozens){
        ...
        request.setAttribute("frozens", frozens);
        request.setAttribute("count", count);
        request.getRequestDispatcher("frozens.jsp").forward(request, response);
    }
