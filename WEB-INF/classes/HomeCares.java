...
@WebServlet("/HomeCares")

public class HomeCares extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            Statement statement = conn.createStatement();
             if(sid==0){
                ...
                String selectStoreQuery = "Select * from product_details where s1='YES' and Category='Home Care';";
                ...
                String selectStoreQuery = "Select * from product_details where s2='YES' and Category='Home Care';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s3='YES' and Category='Home Care';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s4='YES' and Category='Home Care';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s5='YES' and Category='Home Care';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
        ...
        int count=homecares.size();
        for(Product p : homecares){
        ...
        request.setAttribute("homecares", homecares);
        request.setAttribute("count", count);
        request.getRequestDispatcher("homecares.jsp").forward(request, response);
    }
