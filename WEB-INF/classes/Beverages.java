        ...
        try{
            ...
            Statement statement = conn.createStatement();
             if(sid==0){
                ...
                String selectStoreQuery = "Select * from product_details where s1='YES' and Category='Beverages';";
                ...
                String selectStoreQuery = "Select * from product_details where s2='YES' and Category='Beverages';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s3='YES' and Category='Beverages';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s4='YES' and Category='Beverages';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s5='YES' and Category='Beverages';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
