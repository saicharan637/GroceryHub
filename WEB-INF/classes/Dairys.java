...
public class Dairys extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            Statement statement = conn.createStatement();
             if(sid==0){
                ...
                String selectStoreQuery = "Select * from product_details where s1='YES' and Category='Dairy&Bakery';";
                ...
                String selectStoreQuery = "Select * from product_details where s2='YES' and Category='Dairy&Bakery';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s3='YES' and Category='Dairy&Bakery';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s4='YES' and Category='Dairy&Bakery';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
                ...
                String selectStoreQuery = "Select * from product_details where s5='YES' and Category='Dairy&Bakery';";
                ResultSet rs = statement.executeQuery(selectStoreQuery);
        ...
        int count=dairys.size();
        for(Product p : dairys){
        ...
        request.setAttribute("dairys", dairys);
        request.setAttribute("count", count);
        request.getRequestDispatcher("dairys.jsp").forward(request, response);
    }
