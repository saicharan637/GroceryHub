...
@WebServlet("/AdminCateogrySalesGraph")

public class AdminCateogrySalesGraph extends HttpServlet {
...
//         }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {  
                    ...
                    try {
                        getConnection();
                        String getData = "SELECT purchaseDate, sum(distinct(orderTotal)) as totalSales FROM groceryhub.customerorders group by purchaseDate;";
