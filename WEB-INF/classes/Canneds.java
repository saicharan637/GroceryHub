...
public class Canneds extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       try{
        ...
        if(sid==0){
            ...
            String selectStoreQuery = "Select * from product_details where s1='YES' and Category='canned';";
            ...
            String selectStoreQuery = "Select * from product_details where s2='YES' and Category='canned';";
            ResultSet rs = statement.executeQuery(selectStoreQuery);
            ...
            String selectStoreQuery = "Select * from product_details where s3='YES' and Category='canned';";
            ResultSet rs = statement.executeQuery(selectStoreQuery);
            ...
            String selectStoreQuery = "Select * from product_details where s4='YES' and Category='canned';";
            ResultSet rs = statement.executeQuery(selectStoreQuery);
            ...
            String selectStoreQuery = "Select * from product_details where s5='YES' and Category='canned';";
            ResultSet rs = statement.executeQuery(selectStoreQuery);
    ...
    int count=canneds.size();
    for(Product p : canneds){
    ...
    request.setAttribute("canneds", canneds);
    request.setAttribute("count", count);
    request.getRequestDispatcher("canneds.jsp").forward(request, response);
}
